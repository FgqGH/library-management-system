...
class _AdminLoginPageState extends State<AdminLoginPage> {
  ...
  Future<void> _login() async {
    ...
    final ok = await context.read<AuthProvider>().adminLogin(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('管理员登录', style: Theme.of(context).textTheme.headlineSmall, textAlign: TextAlign.center),
                    ...
                    TextButton(onPressed: () => context.go('/login'), child: const Text('← 读者登录')),
                  ],
                ),
              ),
            ),
